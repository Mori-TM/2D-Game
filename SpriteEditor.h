...
{
	glCreateWindow("Sprite Editor", Width, Height + 30, Width, Height, GL_WINDOW_DYNAMIC_ASPECT, &SpriteWindow);
	glCreateFramebuffer(Width, Height, &SpriteFramebuffer);
}
...
void SpriteEditorUpdate()
{
	...
	case GL_EVENT_RESIZE:
		glResizeFramebuffer(SpriteWindow.Width, SpriteWindow.Height, &Framebuffer);
		break;
	...
	{
		glClearFramebuffer(35, &SpriteFramebuffer);
